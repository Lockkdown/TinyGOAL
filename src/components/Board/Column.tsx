      ...
      <header className="mb-3 flex items-center justify-between gap-2">
        ...
        {status === 'Todo' && (
          <button
            ...
            onClick={onAddTask}
            className="rounded-md bg-tk-surface p-1 text-tk-text-2 shadow-sm ring-1 ring-tk-border transition-colors hover:bg-neutral-300 hover:text-tk-text-1 hover:ring-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-100 dark:hover:ring-neutral-600"
